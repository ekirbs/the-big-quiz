...
quizCont.setAttribute("style", "text-align: center; color: white; background: black; margin: 10% 30%;");
questionBody.setAttribute("style", "text-align: left; padding: 1% 15%;");
timerEl.setAttribute("style", "float: right;");
scoreL.setAttribute("style", "float: left;");
